...
class PdfSplitter:
    ...
    def split_and_write(self, pages_per_part):
        ...
        if pages_per_part <= 0 or pages_per_part >= self.total_pages:
            ...
            pages_per_part = int(input("Enter a valid number of pages per part: "))
        ...
        for part_number in range(1, num_parts + 1):
            start_page, end_page = self._get_page_range(pages_per_part)
            writer = fitz.open()
    ...
    def _get_page_range(self, pages_per_part):
        """
        Prompts the user to enter the page range for each part.
        ...
        """
        start_page = int(input(f"Enter the starting page for this part (1 - {self.total_pages}): "))
        end_page = int(input(f"Enter the ending page for this part (1 - {self.total_pages}): "))

        # Ensure valid page range
        while start_page < 1 or end_page > self.total_pages or start_page >= end_page:
            print("Invalid page range. Please enter a valid range.")
            start_page = int(input(f"Enter the starting page for this part (1 - {self.total_pages}): "))
            end_page = int(input(f"Enter the ending page for this part (1 - {self.total_pages}): "))
